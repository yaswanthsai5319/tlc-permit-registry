...
import TLCAdminDashboard from './components/TLCAdminDashboard'; // Import TLC dashboard
...
export default function Home() {
    ...
    const handleSubmit = (e) => {
        ...
        // TLC login check
        if (loginType === 'tlc' && username === 'tlc' && password === 'tlc123') {
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
                <div className="max-w-4xl w-full">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        ...
                        <button
                            onClick={() => setLoginType('tlc')}
                            className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
                        >
                            <Shield className="w-16 h-16 text-green-600 mx-auto mb-4" />
                            <h2 className="text-2xl font-bold text-gray-800 mb-2">TLC Login</h2>
                            <p className="text-gray-600">For TLC super-admins to view advanced analytics</p>
                        </button>
                    </div>
                </div>
            </div>
